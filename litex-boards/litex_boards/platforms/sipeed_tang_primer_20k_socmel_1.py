...
_io = [
 ...
 # SDR.
    ("sdr", 0,
       # Subsignal("MISO_I", Pins("B13"),  IOStandard("LVCMOS33")),      #P12
       # Subsignal("MISO_Q", Pins("R7"),  IOStandard("LVCMOS33")),    #L15
       # Subsignal("MOSI_I",  Pins("A14"), IOStandard("LVCMOS33")),      #J13
       # Subsignal("MOSI_Q", Pins("D10"), IOStandard("LVCMOS33")),       #C16
       # Subsignal("SCK_I", Pins("C12"),  IOStandard("LVCMOS33")),    #L15
       # Subsignal("SCK_Q",  Pins("P7"), IOStandard("LVCMOS33")),      #J13
       # Subsignal("SSEL_I", Pins("B12"), IOStandard("LVCMOS33")),       #C16
       # Subsignal("SSEL_Q", Pins("B11"), IOStandard("LVCMOS33")),      #F12


       Subsignal("RFOut", Pins("B14"),  IOStandard("LVCMOS33")),      #B14
    
       Subsignal("TX_NCO", Pins("A14"), IOStandard("LVCMOS33")),   #G13
       Subsignal("TX", Pins("D15"), IOStandard("LVCMOS33")),        #T3
 # Enable for BIT_1_ADC
       Subsignal("RFIn_p", Pins("D14"), IOStandard("LVDS25")),        #T3
       Subsignal("RFIn_n", Pins("E15"), IOStandard("LVDS25")),        #T3
 # End Enable

       Subsignal("PA_EN", Pins("R16"), IOStandard("LVCMOS33")),        #T3
       Subsignal("HP_DIN", Pins("P15"), IOStandard("LVCMOS33")),        #T3
       Subsignal("HP_WS", Pins("P16"), IOStandard("LVCMOS33")),        #T3
       Subsignal("HP_BCK", Pins("N15"), IOStandard("LVCMOS33")),        #T3
    ),

     # SPILCD.
    ("spilcd", 0,
       Subsignal("lcd_bl", Pins("P12"),  IOStandard("LVCMOS33")),      #P12
       Subsignal("lcd_data", Pins("L15"),  IOStandard("LVCMOS33")),    #L15
       Subsignal("lcd_rs",  Pins("J13"), IOStandard("LVCMOS33")),      #J13
       Subsignal("lcd_cs", Pins("C16"), IOStandard("LVCMOS33")),       #C16
       Subsignal("lcd_clk", Pins("F12"), IOStandard("LVCMOS33")),      #F12
       Subsignal("lcd_resetn", Pins("G13"), IOStandard("LVCMOS33")),   #G13
   #    Subsignal("testrst", Pins("A11"), IOStandard("LVCMOS33")),        #T3
    ),
...
_dock_io = [
    # r9s
    ("led", 0,  Pins( "CARD1:44"), IOStandard("LVCMOS33")), # Was LVCMOS18
    ("led", 1,  Pins( "CARD1:46"), IOStandard("LVCMOS33")), # Was LVCMOS18
    ("led", 3,  Pins( "CARD1:40"), IOStandard("LVCMOS33")), # Was LVCMOS18
    ("led", 2,  Pins( "CARD1:42"), IOStandard("LVCMOS33")), # Was LVCMOS18
...
# Disabled, need pins for PMODs, specifically RFIn and RFOut
    # # LCD.
    # ("lcd", 0,
    #     # Control.
...
class Platform(GowinPlatform):
    ...
    def __init__(self, dock="standard", toolchain="gowin"):
        ...
        print(">>> XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXUsing custom platform with dock =", dock)
