...
from litex_boards.platforms import sipeed_tang_primer_20k_socmel_1

from litedram.common import PHYPadsReducer
from litedram.modules import MT41K64M16
from litedram.phy import GW2DDRPHY
from myperiph import MyPeriph
from myperiph2 import MyPeriph2
from sdr_periph import 	SDRPeriph
...
class BaseSoC(SoCCore):
    def __init__(self, toolchain="gowin", sys_clk_freq=48e6,
        ...
        **kwargs):
        ...
        platform = sipeed_tang_primer_20k_socmel_1.Platform(dock, toolchain=toolchain)
 ...
 #       self.add_csr("leds")  # Expose over CSR
  ...
  #          self.add_csr("buttons")  # Expose over CSR
        ...
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/myperiph.v")
        self.submodules.myperiph = MyPeriph(platform)
        self.add_csr("myperiph")

  #      platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/myperiph2.v")
  #      self.submodules.myperiph2 = MyPeriph2(platform)
  #      self.add_csr("myperiph2")

        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/sdr_periph.v")
  #      platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/CIC.v")
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/Hilbert.v")
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/NCO.v")
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/pt8211_drive.v")
 # Non Abilitare      platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/PWM.v")
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/SinCos.v")
 # Non Abilitare     platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/TX_SPI.v")
 #       platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/gowin_mult.v")
 #       platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/gowin_mult1.v")
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/dds_ii.v")
        platform.add_source("/home/alberto/self_socmel_1/litex-boards/litex_boards/targets/socmel_1/sdr_periph/verilog/cic_filter.v")
...
def main():
    ...
    parser = LiteXArgumentParser(platform=sipeed_tang_primer_20k_socmel_1.Platform, description="LiteX SoC on Tang Primer 20K.")
